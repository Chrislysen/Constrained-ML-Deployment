"""Base optimizer interface — all optimizers (TBA + baselines) implement this."""
...
class BaseOptimizer(ABC):
    ...
    def __init__(
        ...
        self.constraints = constraints  # e.g. {"latency_p95_ms": 20, "memory_peak_mb": 512}
        self.objective = objective  # "maximize_accuracy" or "maximize_throughput"
        self.budget = budget
        self.seed = seed
